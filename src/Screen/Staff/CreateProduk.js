...
export default class CreateProduk extends Component {
  ...
  createproduct() {
    ...
    url = 'https://s-mart-pos.herokuapp.com/api/createProduct';
    ...
    fetch(url, {
      ...
      .then((resJson) => {
        console.log(resJson);
        console.log(Kategory.id);
        if (resJson.message == "successfully added product" ) {
    ...
    return (
      <ScrollView style={{flex: 1}}>
        <View
          ...
          <Text style={{fontSize: 20, color: 'white'}}>Create Produk</Text>
        </View>
        ...
        <View
          ...
          <View style={{paddingHorizontal: 5}}>
            <Text style={{...styles.sizeteks}}>Kode Produk(uid)</Text>
            <TextInput
